...
| I want to...                         | Read                                                          |
| ------------------------------------ | ------------------------------------------------------------- |
| Install, run, or update DataForge    | [Getting started](getting-started.md)                         |
| Learn the gallery, jobs, and editors | [User guide](user-guide.md)                                   |
| Know which files DataForge writes    | [Files DataForge creates](user-guide.md#files-dataforge-creates) |
